...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kpma8vq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kpma8vq.containers.anotherwebservice.com/
...
```
git clone git@github.com:InitialXKO/container-kpma8vq.git
cd container-kpma8vq
```
...
```
docker attach container-kpma8vq
```
